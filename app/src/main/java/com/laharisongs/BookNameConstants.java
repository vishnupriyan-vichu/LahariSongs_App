...
//        GITA_BOOK(5, 2, new String[] {"BG_E:-:", "BG_T:-:", "BG_TE:-:"})
        ...
        ENGLISH_BOOKS(3, new String[]{BookKey.ES + ":-:English songs", BookKey.EC + ":-:English chorus", BookKey.GHc + ":-:German and Hebrew chorus", BookKey.OTSE + ":-:Songs of God's Righteousness"}),
